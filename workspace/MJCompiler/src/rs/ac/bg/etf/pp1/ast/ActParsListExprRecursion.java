...
public class ActParsListExprRecursion extends ActParsList {

    private ActParsList ActParsList;
    private Expr Expr;

    public ActParsListExprRecursion (ActParsList ActParsList, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActParsListExprRecursion(\n");
